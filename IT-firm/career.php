		...
		<div class="auto-container">
			...
			<div class="row  clearfix page-content">
				...
				<!-- Service Block Two -->
                    ...
                    <!-- Service Block Two -->
					<div style="background-image: url(assets/images/career/youth-cleaning-forest-from-trash.jpg);" class="career-card service-block_two-inner col-lg-3 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="1050ms" data-wow-duration="1500ms">
                        <div class="content">
					...
					<div class="step-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="row clearfix">
							...
							<div class="step-block_one-content col-lg-6 col-md-12 col-sm-12">
								<div class="step-block_one-content-inner-career">
							...
							<div class="step-block_one-number-column col-lg-6 col-md-12 col-sm-12">
								<div class="step-block_one-number-inner">
									<div class="d-flex step-block_one-number-content">
										...
										<span class="step-one_icon"><img src="assets/images/icons/step-1.png" alt="" /></span>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="footer-widget instagram-widget">
									...
									<div class="widget-content">
										<div class="images-outer clearfix">
											<!--Image Box-->
											<figure class="image-box"><a class="lightbox-image" href="assets/images/gallery/project-1.jpg"><img src="assets/images/gallery/footer-gallery-thumb-1.jpg" alt=""></a></figure>
											<!--Image Box-->
											<figure class="image-box"><a class="lightbox-image" href="assets/images/gallery/project-2.jpg"><img src="assets/images/gallery/footer-gallery-thumb-2.jpg" alt=""></a></figure>
											<!--Image Box-->
											<figure class="image-box"><a class="lightbox-image" href="assets/images/gallery/project-3.jpg"><img src="assets/images/gallery/footer-gallery-thumb-3.jpg" alt=""></a></figure>
											<!--Image Box-->
											<figure class="image-box"><a class="lightbox-image" href="assets/images/gallery/project-4.jpg"><img src="assets/images/gallery/footer-gallery-thumb-4.jpg" alt=""></a></figure>
											<!--Image Box-->
											<figure class="image-box"><a class="lightbox-image" href="assets/images/gallery/project-5.jpg"><img src="assets/images/gallery/footer-gallery-thumb-5.jpg" alt=""></a></figure>
											<!--Image Box-->
											<figure class="image-box"><a class="lightbox-image" href="assets/images/gallery/project-6.jpg"><img src="assets/images/gallery/footer-gallery-thumb-6.jpg" alt=""></a></figure>
										</div>
									</div>
								</div>
							</div>
...
<script src="style/js/service.js">
</script>
